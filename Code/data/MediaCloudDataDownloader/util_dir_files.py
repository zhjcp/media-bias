...
def get_file_name_list(media_name, year_month):
    ...
    :return:
    """
    dir_path = '/home/newsgrid/zhuhua/NHB/data/corpus/json_data/version_1/'+media_name+'/'+year_month+'/'
...
def load_corpus_byMediaName(mediaName, year_month):
    ...
    dir_path = '/home/newsgrid/zhuhua/NHB/data/corpus/json_data/version_1/' + mediaName + '/' + year_month + '/'
