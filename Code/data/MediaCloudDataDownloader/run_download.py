...
class MediaEnums(Enum):
    ...
    # DailyMail = 301169
    # The_Guardian = 300560
    # Daily_Telegraph = 1750
    # BBC = 1094
    # Evening_Express = 396985
...
def get_one_article(story, cur_media_name, year_month, save_format='json'):
    ...
    save_dir = '/home/newsgrid/zhuhua/NHB/data/corpus/json_data/version_1/' + cur_media_name + '/' + year_month
...
if __name__ == '__main__':
    ...
    for media in MediaEnums:
        print("*** ", media.name, " ***")
        for year in range(2016, 2021+1):  # 2016~2021
            fetched_count = 0
            success_count = 0
            fail_count = 0
