#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @File  : 1_download_mention_tables.py
# @Author: Hua Zhu
# @Date  : 2022/3/20
...
def read_file_url_list(file_type):
    ...
    :return:
    """
    root_dir = '/home/newsgrid/zhuhua/NHB/data/gdelt/file_list/'
    file_url_list = []
...
def download_one_file(file_type, file_url, file_dir, file_name):
    ...
    :return:
    """
    root_dir = '/home/newsgrid/zhuhua/NHB/data/gdelt/' + file_type + '/zip/'
...
def unzip_all_file(file_type, year_month):
    ...
    :return:
    """
    src_dir = '/home/newsgrid/zhuhua/NHB/data/gdelt/' + file_type + '/zip/' + year_month + '/'
    tgt_dir = '/home/newsgrid/zhuhua/NHB/data/gdelt/' + file_type + '/unzip/' + year_month + '/'
...
def read_csv_list_sequential(file_type, year_month):
    ...
    :return:
    """
    root_dir = '/home/newsgrid/zhuhua/NHB/data/gdelt/' + file_type + '/unzip/' + year_month + '/'
...
def transform_csv_to_txt(file_type, year_month):
    ...
    save_dir = '/home/newsgrid/zhuhua/NHB/data/gdelt/' + file_type + '/csv_to_txt/'
