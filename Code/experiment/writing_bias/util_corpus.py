...
def load_corpus_byMediaName_json(mediaName, year_set=None):
    ...
    dir_path = '/home/newsgrid/zhuhua/NHB/data/MediaCloudDataDownloader/download_output/json_data/' + mediaName + '/'
...
def load_corpus_byMediaName_json_new(mediaName, year_set=None):
    ...
    dir_path = '/home/newsgrid/zhuhua/NHB/data/corpus/json_data/version_1/' + mediaName + '/'
...
def save_total_corpus_as_pkl_by_mediaName(media_name, year_set=None):
    ...
    save_dir = '/home/newsgrid/zhuhua/NHB/data/corpus/all_in_one/' + media_name + '/'
...
def load_total_corpus_from_pkl_by_mediaName(media_name, year_set=None):
    ...
    root_dir = '/home/newsgrid/zhuhua/NHB/data/corpus/all_in_one/' + media_name + '/'
    if year_set is None:
        suffix = '_all'
    else:
        suffix = '_' + str(year_set[0]) + '_' + str(year_set[-1])
...
def create_dataset_for_w2v_single_media(media_name, year_set=None, max_news_num=None, random_seed=None, seg_num=1):
    ...
    # 保存数据
    save_dir = '/home/newsgrid/zhuhua/NHB/data/corpus/sentence_words/' + str(random_seed) + '/' + media_name + '/'
    if not os.path.exists(save_dir):
        os.makedirs(save_dir, exist_ok=True)
    if year_set is None:
        suffix = '_all'
...
def load_dataset_from_pkl_by_mediaName(media_name, year_set=None, max_news_num=None, random_seed=None, seg_num=1):
    ...
    root_dir = '/home/newsgrid/zhuhua/NHB/data/corpus/sentence_words/' + str(random_seed) + '/' + media_name + '/'
    if year_set is None:
        suffix = '_all'
    else:
        suffix = '_' + str(year_set[0]) + '_' + str(year_set[-1])
...
class SentencesDatasetGenerator(object):
    ...
    def __init__(self, media_list, random_seed):
        self.dir_path = '/home/newsgrid/zhuhua/NHB/data/corpus/sentence_words/' + str(random_seed) + '/'
