#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @File  : 7_2_word2vec_t-test_single sample.py
# @Author: Hua Zhu
# @Date  : 2022/9/7
# @Desc  :
import pickle
...
def load_media_target_matrix(random_seed, topic_words):
    # if random_seed != 35 and random_seed != 36:  # 仅测试 ！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！
    #     random_seed = 33
    # root_dir = '/home/newsgrid/zhuhua/NHB/data/bias_random_v1/'
    root_dir = '/home/newsgrid/zhuhua/NHB/data/bias_random/'
